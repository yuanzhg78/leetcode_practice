class Codec:
    ...
    def encode(self, longUrl):
        ...
        if longUrl in self.mapping:
            ...
            randomChars = (random.choice(ascii_letters + digits) for _ in range(6))
            shortUrl = baseUrl + "".join(randomChars)
            self.mapping[longUrl] = shortUrl
            return shortUrl
    ...
    def decode(self, shortUrl):
        ...
        :rtype: str
        """
        if shortUrl in self.mapping.values():
